...
if(NOT DEFINED OpenCASCADE_SOURCE_DIR)
  message(FATAL_ERROR "OpenCASCADE_SOURCE_DIR must be defined")
endif()
...
string(REGEX REPLACE "(target_include_directories\\([ \t]?[^ )]+[ \t]?[^ )]+[ \t]?[^ )]+[ \t]?)+\\)" "\\1 \"${OpenCASCADE_BINARY_DIR}/include/opencascade\" \"${OpenCASCADE_SOURCE_DIR}/src/Expr\" \"${OpenCASCADE_SOURCE_DIR}/src/ExprIntrp\" \"${rapidjson_SOURCE_DIR}/include\")" content "${content}")
...
if(NOT content MATCHES "set_property(TARGET OCP PROPERTY SUFFIX \".\${SKBUILD_SOABI}\${CMAKE_SHARED_MODULE_SUFFIX}\")")
